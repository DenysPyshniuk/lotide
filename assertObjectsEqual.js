...
if (eqObjects(actualObject, expectedObject)) {
  console.log(`✅️ Assertation Passed: ${inspect(actualObject)} === ${inspect(expectedObject)}`);
} else {
  console.log(`🛑️ Assertation Failed: ${inspect(actualObject)} !== ${inspect(expectedObject)}`);
}
};